...
/* harmony export */   "getModelViewer": () => (/* binding */ getModelViewer),
/* harmony export */   "getQrURL": () => (/* binding */ getQrURL),
/* harmony export */   "initModelViewer": () => (/* binding */ initModelViewer),
/* harmony export */   "onProductInit": () => (/* binding */ onProductInit)
/* harmony export */ });
/* harmony import */ var focus_visible__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! focus-visible */ "./node_modules/focus-visible/dist/focus-visible.js");
/* harmony import */ var focus_visible__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(focus_visible__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _switcher__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./switcher */ "./src/switcher.ts");
...
/* harmony import */ var _model_viewer__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./model-viewer */ "./src/model-viewer.ts");
/* global wp */
 ...
 */
const getModelViewer = container => {
  if (container) {
...
const getQrURL = productID => {
  const modelVR = document.getElementById('vsge-vr-model');
  if (modelVR && productID) return (0,_utils__WEBPACK_IMPORTED_MODULE_3__.getQRCode)(modelVR, productID);
};
 ...
 */
const getModelID = container => container?.dataset.model || null;
 ...
 */
const initModelViewer = mvContainer => {
  // execute loading
  if (document.body.classList.contains('attachment')) {
    mvContainer.addEventListener('progress', e => (0,_utils__WEBPACK_IMPORTED_MODULE_3__.attachmentPageInit)(e, mvContainer));
  } else {
    mvContainer.addEventListener('progress', _utils__WEBPACK_IMPORTED_MODULE_3__.onProgress);
  }

  // throw an error if the model fails to load
  mvContainer.addEventListener('ar-status', _utils__WEBPACK_IMPORTED_MODULE_3__.throwErrorOnFail);
  document.body.addEventListener('mouseover', _utils__WEBPACK_IMPORTED_MODULE_3__.onInteraction, {
    once: true
  });
  document.body.addEventListener('touchmove', _utils__WEBPACK_IMPORTED_MODULE_3__.onInteraction, {
    once: true
  });
  document.body.addEventListener('scroll', _utils__WEBPACK_IMPORTED_MODULE_3__.onInteraction, {
    once: true
  });
  document.body.addEventListener('keydown', _utils__WEBPACK_IMPORTED_MODULE_3__.onInteraction, {
    once: true
  });
  mvContainer.onmouseleave = () => (0,_model_viewer__WEBPACK_IMPORTED_MODULE_4__.stopRotate)(mvContainer);
  mvContainer.oncontextmenu = ev => ev.preventDefault();
};
 ...
 * @param {ModelViewerElement} mvContainer - The model-viewer element.
 */
const onProductInit = mvContainer => {
  const buttonArInit = document.getElementById('ar-init');
  const button3dRecenter = document.getElementById('ar-center');
  const modalToggleHotspot = document.getElementById('ar-toggle-hotspots');
  const button3dRotation = document.getElementById('ar-rotation');
  if (buttonArInit) buttonArInit.onclick = e => (0,_model_viewer__WEBPACK_IMPORTED_MODULE_4__.arInitialize)(e, mvContainer);
  if (modalToggleHotspot) modalToggleHotspot.onclick = e => (0,_model_viewer__WEBPACK_IMPORTED_MODULE_4__.toggleHotspot)(e, mvContainer);
  if (button3dRecenter) button3dRecenter.onclick = e => (0,_model_viewer__WEBPACK_IMPORTED_MODULE_4__.setRecenter)(e, mvContainer);
  if (button3dRotation) button3dRotation.onclick = e => (0,_model_viewer__WEBPACK_IMPORTED_MODULE_4__.setAutoRotation)(e, mvContainer);
  mvContainer.onmouseenter = () => (0,_model_viewer__WEBPACK_IMPORTED_MODULE_4__.enableAutoRotate)(button3dRotation, mvContainer);
};
...
window.addEventListener('load', () => {
  const container3d = document.getElementById('woocommerce-product-gallery__3d');
  const mvContainer = getModelViewer(container3d);
  ...
  if (mvContainer) {
     ...
     */
    (0,_switcher__WEBPACK_IMPORTED_MODULE_1__.init3dControls)();
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "arInitialize": () => (/* binding */ arInitialize),
/* harmony export */   "centerView": () => (/* binding */ centerView),
/* harmony export */   "enableAutoRotate": () => (/* binding */ enableAutoRotate),
/* harmony export */   "fireButtonState": () => (/* binding */ fireButtonState),
/* harmony export */   "getAutoRotation": () => (/* binding */ getAutoRotation),
/* harmony export */   "isSelected": () => (/* binding */ isSelected),
/* harmony export */   "metersPerPixel": () => (/* binding */ metersPerPixel),
/* harmony export */   "panX": () => (/* binding */ panX),
/* harmony export */   "panY": () => (/* binding */ panY),
/* harmony export */   "panning": () => (/* binding */ panning),
/* harmony export */   "recenter": () => (/* binding */ recenter),
/* harmony export */   "setAutoRotation": () => (/* binding */ setAutoRotation),
/* harmony export */   "setRecenter": () => (/* binding */ setRecenter),
/* harmony export */   "startPan": () => (/* binding */ startPan),
/* harmony export */   "startRotate": () => (/* binding */ startRotate),
/* harmony export */   "startX": () => (/* binding */ startX),
/* harmony export */   "startY": () => (/* binding */ startY),
/* harmony export */   "stopRotate": () => (/* binding */ stopRotate),
/* harmony export */   "tapDistance": () => (/* binding */ tapDistance),
/* harmony export */   "toggleHotspot": () => (/* binding */ toggleHotspot),
/* harmony export */   "toggleHotspotVisibility": () => (/* binding */ toggleHotspotVisibility)
/* harmony export */ });
 ...
 * @param         container
 */
const arInitialize = (event, container) => {
  if (container?.canActivateAR) {
    ...
    container.activateAR().catch(err => console.log(err));
  } else {
    const modalGenerateQR = document.getElementById('vsge-modal-qrcode') || null;
    modalGenerateQR?.addEventListener('click', _utils__WEBPACK_IMPORTED_MODULE_0__.deactivateQR);
 ...
 * @param  mvContainer
 */
const enableAutoRotate = (button3dRotation, mvContainer) => {
 ...
 */
const fireButtonState = (button, enabled) => {
  if (enabled) {
 ...
 * @param  container
 */
const setAutoRotation = (event, container) => {
  if (isSelected(event)) {
...
const startPan = container => {
  if (container) {
    ...
    metersPerPixel = 0.75 * radius / container.getBoundingClientRect().height;
 ...
 * @param  container
 */
const centerView = container => {
  if (container) {
    var _container$cameraOrbi, _container$cameraTarg;
    const initialCameraOrbit = (_container$cameraOrbi = container?.cameraOrbit) !== null && _container$cameraOrbi !== void 0 ? _container$cameraOrbi : '';
    const initialCameraTarget = (_container$cameraTarg = container?.cameraTarget) !== null && _container$cameraTarg !== void 0 ? _container$cameraTarg : '';
    panning = false;
 ...
 * @return {void}
 */
const recenter = function (container) {
  let pointer = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {
    clientX: 0,
    clientY: 0
  };
  panning = false;
  if (!container || Math.abs(pointer.clientX - startX) > tapDistance || Math.abs(pointer.clientY - startY) > tapDistance) return;
  const hit = container.positionAndNormalFromPoint(pointer.clientX, pointer.clientY);
  container.cameraTarget = hit === null ? 'auto auto auto' : hit.position.toString();
};
 ...
 * @param {ModelViewerElement} container
 */
const setRecenter = (event, container) => {
 ...
 */
const toggleHotspotVisibility = (hotspots, isActive) => {
 ...
 * @param {ModelViewerElement} container
 */
const toggleHotspot = (event, container) => {
  if (container) {
    const hotspots = container.querySelectorAll('div.hotspot');
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "init3dControls": () => (/* binding */ init3dControls)
/* harmony export */ });
/**
...
function init3dControls() {
  ...
  const switcherContainerButtons = switcherContainer ? switcherContainer.getElementsByTagName('button') : null;
  if (switcherContainerButtons) {
    const modelViewerWrapper = document.getElementById('woocommerce-product-gallery__3d') || null;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "attachmentPageInit": () => (/* binding */ attachmentPageInit),
/* harmony export */   "deactivateQR": () => (/* binding */ deactivateQR),
/* harmony export */   "getQRCode": () => (/* binding */ getQRCode),
/* harmony export */   "logModelError": () => (/* binding */ logModelError),
/* harmony export */   "onInteraction": () => (/* binding */ onInteraction),
/* harmony export */   "onProgress": () => (/* binding */ onProgress),
/* harmony export */   "throwErrorOnFail": () => (/* binding */ throwErrorOnFail)
/* harmony export */ });
 ...
 */
const onInteraction = () => {
  const arButton = document.getElementById('ar-button') || null;
 ...
 */
function getQRCode(canvas, id) {
  if (canvas && id) {
    // @ts-ignore
    const url = vsgenv.siteurl + '/?attachment_id=' + id;
    qrcode__WEBPACK_IMPORTED_MODULE_0__.toCanvas(canvas, url, error => {
...
const onProgress = event => {
  ...
  if (progress) {
    ...
    const updatingBar = progress.querySelector('.progress-bar');
...
function attachmentPageInit(event, container) {
  const progress = event.currentTarget;
  if (progress) {
    /** Modal */
    ...
    if (modal) {
      ...
      if (event.detail.totalProgress === 1) {
        /** AR Button */
        const arButton = container.querySelector('.ar-button');
 ...
 */
const logModelError = (container, errorMessage) => {
...
/******/ 		var installedChunks = {
/******/ 			"vsge-3d-product-viewer": 0,
/******/ 			"./style-vsge-3d-product-viewer": 0
/******/ 		};
/******/ 		
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkvsge_3d_product_viewer"] = self["webpackChunkvsge_3d_product_viewer"] || [];
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["./style-vsge-3d-product-viewer"], () => (__webpack_require__("./src/index.ts")))
/******/ 	__webpack_exports__ = __webpack_require__.O(__webpack_exports__);
/******/ 	
/******/ })()
;
//# sourceMappingURL=vsge-3d-product-viewer.js.map